...
import 'package:very_good_coffee/data/mappers/coffee/coffee_mappers.dart'
    as _i7;
import 'package:very_good_coffee/data/network/api/api.dart' as _i4;
...
import '../data/network/api/api.dart' as _i8;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i7.FavoriteCoffeeMapper>(
        () => _i7.FavoriteCoffeeMapper());
